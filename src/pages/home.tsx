              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-blue-800 dark:text-gray-300 text-lg leading-relaxed mb-4">
                    ...
                    modern technologies like React, TypeScript, and Tailwind
                    CSS. I love creating beautiful, functional, and
                ...
                <div className="flex justify-center">
                  <div className="w-64 h-64 bg-gradient-to-br from-blue-400 to-blue-600 dark:from-blue-600 dark:to-blue-800 rounded-full shadow-xl flex items-center justify-center">
          ...
          <section className="max-w-6xl mx-auto mb-16">
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-blue-200/50 dark:border-gray-700/50 p-8 md:p-12">
              ...
              <p className="text-blue-700 dark:text-gray-400 text-lg mb-8 text-center">
                My journey in professional work
              </p>
