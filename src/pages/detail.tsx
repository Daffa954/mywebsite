...
export function ProjectDetail() {
  ...
  // 2. Definisi Animasi (Sama seperti Home, tapi pakai animate="visible" agar langsung muncul)
    ...
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
      ...
      <main className="flex-grow py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* 3. Wrap konten utama dengan motion.div */}
          <motion.div
            initial="hidden"
            animate="visible" // Menggunakan 'animate' agar langsung jalan saat halaman dibuka
            variants={fadeInUp}
          >
            {/* Back Button */}
            <Link 
